/*! For license information please see simon42-dashboard-strategy-editor.c299a262.js.LICENSE.txt */
    ...
    `:o.s6}_getSectionsOrder(){return this._config.sections_order||[...rt.G]}_updateSectionsOrder(e){const t={...this._config,sections_order:e};this._config=t,this._fireConfigChanged(t)}_isSectionDisabled(e){switch(e){case"custom_cards":return 0===(this._config.custom_cards||[]).length;case"weather":return!1===this._config.show_weather;case"energy":return!1===this._config.show_energy;default:return!1}}_isSectionToggleable(e){return"weather"===e||"energy"===e}_toggleSectionVisibility(e,t){"weather"===e?this._toggleChanged("show_weather",t,!0):"energy"===e&&this._toggleChanged("show_energy",t,!0)}_setWeatherPresentation(e){const t={...this._config,weather_presentation:e};delete t.show_weather_forecast_card,this._config=t,this._fireConfigChanged(t)}_renderSectionOrderPanel(){const e=this._getSectionsOrder(),t=!1!==this._config.energy_link_dashboard,i=!1!==this._config.show_energy,n=!1!==this._config.show_weather,r=!1!==this._config.show_energy_distribution_card,a=this._config.weather_presentation??(!1===this._config.show_weather_forecast_card?"none":"forecast_daily");return o.qy`
      <div class="section">
        ...
        <div class="section-order-list" id="section-order-list">
          ${e.map(e=>{const s=ct._sectionMeta.get(e);if(!s)return o.s6;const c=this._isSectionDisabled(e),l=this._isSectionToggleable(e);return o.qy`
              <div class="section-order-item ${c?"disabled":""}"
                ...
                ${c&&!l?o.qy`<span class="section-hidden-tag">(${(0,at.localize)("editor.section_hidden")})</span>`:o.s6}
                ${l?o.qy`
