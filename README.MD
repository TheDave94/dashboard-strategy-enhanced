...
Semver — current line is **v4.x** on the HA 2025.5+ minimum (newer HA preferred). Release notes per version in [GitHub releases](https://github.com/TheDave94/oriel-dashboard/releases).
